...
# edges
edge_df = pd.read_csv("C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_preproc/edge.csv", index_col=0)
...
torch.save(edge_index, 'C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_dataset/edge_index.pt')
print('C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_dataset/edge_index.pt')
del edge_df

# edge weights
weight_df = pd.read_csv("C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_preproc/weight.csv", index_col=0)
edge_weights = torch.tensor(weight_df.values.astype(np.float32)).view(-1, 1)
torch.save(edge_weights, 'C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_dataset/edge_weights.pt')
print('C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_dataset/edge_weights.pt')
del weight_df
