...
rea_names = ['temp', 'relhum', 'cloudcover',
             'pblheight', 'u', 'v']
cams_names = ['cams_o3', 'cams_no', 'cams_no2',
              'cams_nox_emissions']
meta_names = ['alt', 'relative_alt', 'population_density',
              'nightlight', 'type', 'type_of_area'] ###raw data에서 위의 항목을 모두 불러오기
...
# save
x_df.to_csv("C:/Users/sjjun/OneDrive/Desktop/data_korea/uba_graph_preproc/x.csv")
