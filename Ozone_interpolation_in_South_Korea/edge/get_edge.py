...
station_df = pd.read_csv("C:/Users/ATMOS/Desktop/data/data_gyeonggi/uba_graph_raw/stations.csv", index_col=0)
reg_df = pd.read_csv("C:/Users/ATMOS/Desktop/data/data_gyeonggi/uba_graph_preproc/reg.csv", index_col=0,
...
nn = NearestNeighbors()
nn.fit(coords)
_, idx_lists = nn.radius_neighbors(coords,radius = 9.)
...
def edge_tmp(name):
    ...
    edge_df.to_csv("C:/Users/ATMOS/Desktop/data/data_gyeonggi/uba_graph_preproc/edge_tmp.csv")
...
if __name__ == '__main__':
    ...
    for i in range(4):
        ...
        p = multiprocessing.Process(target=edge_tmp, args=(i, ))
        p.start()
        procs.append(p)
