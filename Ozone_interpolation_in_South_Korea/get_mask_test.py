...
y_df_flat = pd.read_csv("C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_preproc/y.csv", index_col=0)
hd = HourlyData('o3')
hd.read_from_file()
y_df = hd.df
...
mask_df.loc[y_df_flat.y == 300, 'val_mask'] = True
mask_df.loc[y_df_flat.y == 301, 'test_mask'] = True
...
# save
mask_df.to_csv("C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_preproc/mask.csv")

gap_df.to_csv("C:/Users/sjjun/OneDrive/Desktop/data_seoul/uba_graph_preproc/gap.csv")
